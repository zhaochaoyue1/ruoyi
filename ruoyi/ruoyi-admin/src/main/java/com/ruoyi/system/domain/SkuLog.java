 ...
 * @date 2021-05-06
 */
public class SkuLog extends BaseEntity {
    ...
    public SkuLog(Sku sku) {
        this.skuId = sku.getId();
        this.name = sku.getName();
        this.size = sku.getSize();
        this.fromPrice = sku.getFromPrice();
        this.salePrice = sku.getSalePrice();
        this.percentage = sku.getPercentage();
        this.status = sku.getStatus();
        this.score = sku.getScore();
        this.pic = sku.getPic();
        setCreateTime(sku.getCreateTime());
        setCreateId(sku.getCreateId());
        setCreateBy(sku.getCreateBy());
        setUpdateTime(sku.getUpdateTime());
        setUpdateId(sku.getUpdateId());
        setUpdateBy(sku.getUpdateBy());
        this.brand = sku.getBrand();
        this.category = sku.getCategory();
        this.atlas = sku.getAtlas();
    }
